...
from app.schemas.project import ProjectCreate, ProjectResponse, ProjectMemberCreate, ProjectUpdate, MemberResponse, MemberAddResponse
...
@router.post(
    ...
    status_code=201,
    summary="Tạo project",
    description="Tạo project mới và tự động thêm người dùng hiện tại với vai trò OWNER.",
    response_description="Project vừa được tạo",
)
...
@router.get(
    ...
    summary="Danh sách project của tôi",
    description="Lấy các project đang hoạt động mà người dùng hiện tại là thành viên.",
    response_description="Danh sách project",
)
def get_my_projects(
...
@router.get(
    "/{project_id}",
    response_model=ProjectResponse,
    summary="Xem chi tiết project",
    description="Xem thông tin project nếu người dùng hiện tại là thành viên.",
    response_description="Thông tin chi tiết project",
)
...
@router.put(
    ...
    description="Cập nhật thông tin project. Chỉ OWNER được phép thực hiện.",
    response_description="Project sau khi cập nhật",
)
...
@router.delete(
    ...
    response_model=None,
    summary="Xóa project",
    description="Xóa mềm project. Chỉ OWNER được phép thực hiện.",
...
@router.get(
    ...
    description="Lấy danh sách thành viên của project đang hoạt động.",
    response_description="Danh sách thành viên",
)
...
@router.post(
    ...
    status_code=201,
    summary="Thêm thành viên vào project",
    description="OWNER thêm một người dùng hiện có vào project với vai trò MEMBER.",
    response_description="Kết quả thêm thành viên",
)
...
@router.delete(
    ...
    status_code=204,
    response_model=None,
    summary="Xóa thành viên khỏi project",
    description="OWNER xóa một thành viên khỏi project; không thể xóa OWNER.",
    response_description="Không có nội dung trả về",
)
